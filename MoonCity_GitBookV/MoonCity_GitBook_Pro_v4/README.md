...
{% content-ref url="notions-de-base/README.md" %}
[🙏 Notions de bases](notions-de-base/README.md)
{% endcontent-ref %}

{% content-ref url="reglement-legal/README.md" %}
[👨‍⚖️ Règlement Légal](reglement-legal/README.md)
{% endcontent-ref %}

{% content-ref url="reglement-illegal/README.md" %}
[🥷 Règlement Illégal](reglement-illegal/README.md)
{% endcontent-ref %}

{% content-ref url="sanctions-et-support.md" %}
